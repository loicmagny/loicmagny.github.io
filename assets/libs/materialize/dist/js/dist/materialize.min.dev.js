      ...
      if (!(7 >= h)) {
        ...
        var w = function () {
          ...
          return function t(e, n, o) {
            ...
            for (e = parseFloat(e) || 500, n = parseFloat(n) || 20, o = o || null, l.tension = e, l.friction = n, (a = null !== o) ? (u = t(e, n), r = u / o * 0.016) : r = 0.016; s = i(s || l, r), c.push(1 + s.x), u += 16, Math.abs(s.x) > 1e-4 && Math.abs(s.v) > 1e-4;) {
              ;
            }
        ...
        }, p.each([['ease', [0.25, 0.1, 0.25, 1]], ['ease-in', [0.42, 0, 1, 1]], ['ease-out', [0, 0, 0.58, 1]], ['ease-in-out', [0.42, 0, 0.58, 1]], ['easeInSine', [0.47, 0, 0.745, 0.715]], ['easeOutSine', [0.39, 0.575, 0.565, 1]], ['easeInOutSine', [0.445, 0.05, 0.55, 0.95]], ['easeInQuad', [0.55, 0.085, 0.68, 0.53]], ['easeOutQuad', [0.25, 0.46, 0.45, 0.94]], ['easeInOutQuad', [0.455, 0.03, 0.515, 0.955]], ['easeInCubic', [0.55, 0.055, 0.675, 0.19]], ['easeOutCubic', [0.215, 0.61, 0.355, 1]], ['easeInOutCubic', [0.645, 0.045, 0.355, 1]], ['easeInQuart', [0.895, 0.03, 0.685, 0.22]], ['easeOutQuart', [0.165, 0.84, 0.44, 1]], ['easeInOutQuart', [0.77, 0, 0.175, 1]], ['easeInQuint', [0.755, 0.05, 0.855, 0.06]], ['easeOutQuint', [0.23, 1, 0.32, 1]], ['easeInOutQuint', [0.86, 0, 0.07, 1]], ['easeInExpo', [0.95, 0.05, 0.795, 0.035]], ['easeOutExpo', [0.19, 1, 0.22, 1]], ['easeInOutExpo', [1, 0, 0, 1]], ['easeInCirc', [0.6, 0.04, 0.98, 0.335]], ['easeOutCirc', [0.075, 0.82, 0.165, 1]], ['easeInOutCirc', [0.785, 0.135, 0.15, 0.86]]], function (t, e) {
                ...
                if (!p.isPlainObject(m) || v.isEmptyObject(m)) {
                  if (v.isString(m) && b.Redirects[m]) {
                    ...
                    return !0 === z.backwards && (f = p.extend(!0, [], f).reverse()), p.each(f, function (t, e) {
                      parseFloat(z.stagger) ? z.delay = _ + parseFloat(z.stagger) * t : v.isFunction(z.stagger) && (z.delay = _ + z.stagger.call(e, t, C)), z.drag && (z.duration = parseFloat(E) || (/^(callout|transition)/.test(m) ? 1e3 : g), z.duration = Math.max(z.duration * (z.backwards ? 1 - t / C : (t + 1) / C), 0.75 * z.duration, 200)), b.Redirects[m].call(e, e, z || {}, t, C, f, P.promise ? P : n);
                    }), t();
                  }
    ...
    return this.each(function () {
      ...
      if (!t(this).hasClass('initialized')) {
        ...
        s.wrap(l), s.on('click', function () {
          ...
          var m = 0,
              g = 0;
          u / l > d / c ? (m = 0.9 * l, g = 0.9 * l * (d / u)) : (m = 0.9 * c * (u / d), g = 0.9 * c), s.hasClass('responsive-img') ? s.velocity({
            'max-width': m,
            width: u
          }, {
            duration: 0,
        ...
        e.draggable && (a.on('click', function () {
          ...
          if ('touch' == i.gesture.pointerType) {
            var n = t('#sidenav-overlay'),
                ...
                u = c - e.menuWidth,
                d = c - e.menuWidth / 2;
            u > 0 && (u = 0), d < 0 && (d = 0), s = !1, 'left' === e.edge ? l && r <= 0.3 || r < -0.5 ? (0 !== u && o.velocity({
              translateX: [0, u]
            }, {
              duration: 300,
              queue: !1,
      ...
      t(this).hammer({
        ...
        if ('touch' === n.gesture.pointerType) {
          ...
          o.velocity({
            ...
            queue: !1,
            easing: 'easeOutQuad'
          }), 4 === a && (r > o.innerWidth() / 2 || s < -0.75) && (e = !0), 2 === a && (r < -1 * o.innerWidth() / 2 || s > 0.75) && (i = !0);
        }
  ...
  var e = {
    init: function init(e) {
      ...
      return this.each(function (i) {
        ...
        function f(t) {
          if (k) return k = !1, clearInterval(D), A = b, (O > 10 || O < -10) && (A = b + (P = 0.9 * O)), A = Math.round(A / x) * x, W && (A >= x * (C - 1) ? A = x * (C - 1) : A < 0 && (A = 0)), P = A - b, I = Date.now(), requestAnimationFrame(c), q && (t.preventDefault(), t.stopPropagation()), !1;
        }
